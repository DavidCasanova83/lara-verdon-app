<div class="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-8">
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="flex justify-between items-center mb-6">
            <a href="{{ route('form.step1', $city) }}" class="flex items-center font-medium transition-colors" style="color: #3B9C92;" onmouseover="this.style.color='#2d7a72'" onmouseout="this.style.color='#3B9C92'">
