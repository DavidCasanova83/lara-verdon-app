...
- [ ] **Filtrage des statistiques** par période, ville, profil
- [ ] **Dashboard administrateur** avec authentification
- [ ] **Sauvegarde automatique** des brouillons de formulaires
- [ ] **API REST** pour intégrations externes
- [ ] **Notifications email** de confirmation aux visiteurs

#### Fonctionnalités utilisateur
- [ ] **Mode hors-ligne** avec synchronisation ultérieure
- [ ] **QR Code** pour accès rapide au formulaire par ville
- [ ] **Formulaire court** (version simplifiée 1 étape)
- [ ] **Multi-langues** (français, anglais, italien, allemand)
- [ ] **Géolocalisation** pour suggestion automatique de ville
- [ ] **Historique** des soumissions par email
